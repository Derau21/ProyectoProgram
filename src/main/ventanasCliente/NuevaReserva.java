...
public NuevaReserva(Menu padre, Cliente cliente) {
		...
		lblSeleccioneHorario.setBounds(205, 251, 163, 25);
		contentPane.add(lblSeleccioneHorario);

		comboHorarios = new JComboBox();
		comboHorarios.setBounds(464, 253, 72, 26);
		...
		btnAceptar.setBounds(262, 352, 115, 29);
		...
		lblSeleccioneHorario_1.setBounds(205, 158, 163, 25);
		contentPane.add(lblSeleccioneHorario_1);
		
				// inicializar Jlist
				list = new JList<Pelicula>();
				list.setBounds(453, 76, 193, 162);
